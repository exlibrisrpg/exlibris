class SystemTokenComponent < ViewComponent::Base
  ...
  def token_class
    class_names(
      "tw-bg-white/20 tw-shadow tw-border-white tw-rounded-full tw-inline-flex tw-items-center tw-transition tw-duration-200 tw-px-4 tw-py-2 tw-border-2 tw-gap-2 tw-select-none tw-relative tw-overflow-hidden tw-group",
